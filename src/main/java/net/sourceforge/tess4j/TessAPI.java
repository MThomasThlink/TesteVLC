...
public interface TessAPI extends Library {
     ...
     */
    String TessBaseAPIRect(TessAPI.TessBaseAPI handle, ByteBuffer imagedata, int bytes_per_pixel, int bytes_per_line, int left, int top, int width, int height);
     ...
     */
    String TessBaseAPIProcessPages(TessAPI.TessBaseAPI handle, String filename, String retry_config, int timeout_millisec);

    /**
     * The recognized text is returned as a char* which is coded as UTF-8 and
     * must be freed with the delete [] operator.
     */
    String TessBaseAPIGetUTF8Text(TessAPI.TessBaseAPI handle);
     ...
     * 1-based.
     */
    String TessBaseAPIGetHOCRText(TessAPI.TessBaseAPI handle, int page_number);
     ...
     */
    String TessBaseAPIGetBoxText(TessAPI.TessBaseAPI handle, int page_number);
     ...
     * delete [] operator.
     */
    String TessBaseAPIGetUNLVText(TessAPI.TessBaseAPI handle);
     ...
     * If hin loaded eng automatically as well, then that will not be included
     * in this list. To find the languages actually loaded use
     * GetLoadedLanguagesAsVector. The returned string should NOT be deleted.
     */
    String TessBaseGetInitLanguagesAsString(TessAPI.TessBaseAPI handle);
    ...
    String TessResultIteratorGetUTF8Text(TessAPI.TessResultIterator handle, int level);
