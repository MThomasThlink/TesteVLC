...
public class TessAPI1 implements Library {
     ...
     */
    public static native String TessBaseAPIRect(TessAPI1.TessBaseAPI handle, ByteBuffer imagedata, int bytes_per_pixel, int bytes_per_line, int left, int top, int width, int height);
     ...
     */
    public static native String TessBaseAPIProcessPages(TessAPI1.TessBaseAPI handle, String filename, String retry_config, int timeout_millisec);

    /**
     * The recognized text is returned as a char* which is coded as UTF-8 and
     * must be freed with the delete [] operator.
     */
    public static native String TessBaseAPIGetUTF8Text(TessAPI1.TessBaseAPI handle);
     ...
     * 1-based.
     */
    public static native String TessBaseAPIGetHOCRText(TessAPI1.TessBaseAPI handle, int page_number);
     ...
     */
    public static native String TessBaseAPIGetBoxText(TessAPI1.TessBaseAPI handle, int page_number);
     ...
     * delete [] operator.
     */
    public static native String TessBaseAPIGetUNLVText(TessAPI1.TessBaseAPI handle);
    ...
    public static native String TessResultIteratorGetUTF8Text(TessAPI1.TessResultIterator handle, int level);
